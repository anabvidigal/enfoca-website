                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="area">
                            ...
                            <form id="contactUs" action="successEmail.php" method="POST">
                                <div class="row">
                                    <div class="col-xs-6">
                                ...
                                <input type="submit" class="btn btn-accent" value="ENVIAR" name="sendMessage" />
                            </form>
                        </div>
                    </div>
                </div>
